...
SELECT * FROM EmpVIEW;
[0:16 pm, 16/08/2023] Asma Al Jabri Makeen Camp : -- INSTEAD TRIGGER VIEW FOR ORDER TABLE
...
INSERT INTO CUSVIEW (OrderNumber, OrderDate, FirstName, LastName)
VALUES ('12345', '2023-08-16', 'John', 'Doe');
